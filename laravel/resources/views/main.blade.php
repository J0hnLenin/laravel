        ...
        @foreach($cards as $card)
            <div id="Card{{ $card->id }}"class="card card-my">
                ...
                <div class="cont cards" >
                    <button class="button-modal btn button-upload button-cont m-1" data-bs-toggle="modal" data-bs-target="#Modal" id="{{$card->id}}">info</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="exampleModalDescUpdate">
                        <form id="formUpdate" class="was-validated" method="POST">
                            ...
                            <div class="mb3" style="position: relative;">
                                <label for="update_title" class="form-label">Card title</label>
                                <textarea minlength="5" maxlength="20" name="title" class="form-control is-invalid" id="update_title" placeholder="Required example textarea" required></textarea>
                            </div>
                            <div class="mb-3" style="position: relative;">
                                <label for="update_description" class="form-label">Card description</label>
                            ...
                            <div class="mb3" style="position: relative;">
                                <label for="update_modal_title" class="form-label">Info title</label>
                                <textarea minlength="5" maxlength="20" name="modal_title" class="form-control is-invalid" id="update_modal_title" placeholder="Required example textarea" required></textarea>
                            </div>
                            <div class="mb-3" style="position: relative;">
                                <label for="update_modal_description" class="form-label">Info description</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="exampleModalDescCreate">
                    <form id="formCreate" class="was-validated" method="POST">
                        ...
                        <div class="mb3" style="position: relative;">
                            <label for="create_title" class="form-label">Card title</label>
                            <textarea minlength="5" maxlength="20" name="title" class="form-control is-invalid" id="create_title" placeholder="Required example textarea" required></textarea>
                        </div>
                        <div class="mb-3" style="position: relative;">
                            <label for="create_description" class="form-label">Card description</label>
                        ...
                        <div class="mb3" style="position: relative;">
                            <label for="create_modal_title" class="form-label">Info title</label>
                            <textarea minlength="5" maxlength="20" name="modal_title" class="form-control is-invalid" id="create_modal_title" placeholder="Required example textarea" required></textarea>
                        </div>
                        <div class="mb-3" style="position: relative;">
                            <label for="create_modal_description" class="form-label">Info description</label>
